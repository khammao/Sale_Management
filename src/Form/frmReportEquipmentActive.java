...
public class frmReportEquipmentActive extends javax.swing.JInternalFrame {
    ...
    public frmReportEquipmentActive() {
        initComponents();
        ButtonGroup();
    }
    ...
    public void ShowReportStore(){
        try {
            ...
            map.put("Loc", dtp);
            map.put("Cate", cat);
                JasperPrint print = JasperFillManager.fillReport("Report\\ReportEquipmentActiveStore.jasper",map, c);
                JFrame fr = new JFrame();
                fr.setTitle("IT Equipment Active Report");
    ...
    public void ShowReportDept(){
        try {
            ...
            map.put("dept", dtp);
            map.put("Cate", cat);
                JasperPrint print = JasperFillManager.fillReport("Report\\ReportEquipmentActive.jasper",map, c);
                JFrame fr = new JFrame();
                fr.setTitle("IT Equipment active Report");
                Dimension dr = Toolkit.getDefaultToolkit().getScreenSize();
                int w = (int)dr.getWidth();
