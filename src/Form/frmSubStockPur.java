...
public class frmSubStockPur extends javax.swing.JDialog {
    ...
    String sql;
     ...
     public String categ;
     public String dtpm;
    public frmSubStockPur(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select the equipment you want");
    ...
    public void showdata(){
        try {
            ...
            String s="SELECT dbo.IV_EquipmentStock.Barcode, dbo.IV_EquipmentStock.EquipmentName, dbo.IV_EquipmentStock.Prices, dbo.IV_EquipmentStock.Qty, dbo.IV_Unit.UnitName, dbo.IV_Brands.BrandName, dbo.CATType.CDesc, \n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSubStockPur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmSubStockPur dialog = new frmSubStockPur(new javax.swing.JFrame(), true);
